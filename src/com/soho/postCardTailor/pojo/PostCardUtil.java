package com.soho.postCardTailor.pojo;
...
/**
 * Created by a1379 on 2016/10/26.
 */
public class PostCardUtil {
    ...
    public static void main(String[] args) throws Exception {
        PostCardUtil imageUtil = new PostCardUtil();
...
// 1.将角度转换到0-360度之间
    ...
    public static boolean zoomImage(String imagePath, String newPath, Integer width,
                                    Integer height) {
        System.out.println("****************************************************************************开始执行图片裁切**************************");
        long startTime = System.nanoTime();
        System.out.println("原始图片路径" + imagePath);
        System.out.println("缩略图路径" + newPath);
        boolean flag = false;
        try {
            IMOperation op = new IMOperation();
            op.addImage(imagePath);
        ...
        System.out.println("****************************************************************************图片裁切执行完毕，总用时：" + (System.nanoTime() - startTime) + "**************************");
        return flag;
    }
